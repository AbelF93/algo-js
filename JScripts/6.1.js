...
/*Create a class named Circle with attributes xPos, yPos and radius.
 Add a method named move(xOffset, yOffset)  
 that will adjust the position of the circle.
 Add a getter accessor named surface that will return the surface 
 of the circle.
 Test its method and accessors by modifying the values and
...
const askMove = console.log(prompt("Do you want to modify the coordinates of your circle ? (y/n)"));
    if(askMove == "y"){
